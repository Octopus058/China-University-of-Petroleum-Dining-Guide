...
\begin{titlepage}
    ...
    \vspace{39pt}
    \fontsize{22}{26.4}\selectfont{\haettenfont v5. 4 . 1\normalfont }\par % 版本
    \vspace{52.8pt}
    \fontsize{18}{21.6}\selectfont{作者：刈夫和石大的同学们}\par % 作者
    \fontsize{18}{21.6}\selectfont{最后编辑时间：2025年7月4日}\par % 最后编辑时间
    \vfill
\end{titlepage}
...
\fontsize{14pt}{16.8pt}\selectfont
\setlength{\parindent}{2em} % 设置首行缩进为2字符
新的润杰食堂作者没去过，但听同学说和现在的禾苑一样烂，好吧，呵呵......
...
川菜馆在5月关了整整24天，导致作者一度不知道吃什么，整天泡在山西面馆和高原里愁容满面，打开美团看川菜馆开没开门。作者的同学评论道：川菜馆应该改名叫媚胃而不是美味。
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.75\textwidth]{pics/校外/清秀园/砂锅面.png}
\end{figure}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.75\textwidth]{pics/校外/清秀园/尝到家尝.png}
\end{figure}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.7\textwidth]{pics/校外/润杰/山西面馆&原哈尔滨麻辣烫.png}
\end{figure}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.75\textwidth]{pics/校外/更远/巴依老爷.png}
\end{figure}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.75\textwidth]{pics/校外/更远/沧州火锅鸡.png}
\end{figure}
北京，人均40块，火锅鸡，免费小菜，自家酿醋，还需要我多说吗，冲就完了！
