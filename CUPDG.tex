...
\begin{titlepage}
    ...
    \vspace{39pt}
    \fontsize{22}{26.4}\selectfont{\haettenfont v6. 0\normalfont }\par % 版本
    \vspace{52.8pt}
    \fontsize{18}{21.6}\selectfont{作者：刈夫和石大的同学们}\par % 作者
    \fontsize{18}{21.6}\selectfont{最后编辑时间：2025年8月23日}\par % 最后编辑时间
    \vfill
\end{titlepage}
...
\fontsize{14pt}{16.8pt}\selectfont
\setlength{\parindent}{2em} % 设置首行缩进为2字符
禾苑在经过一次脱胎换骨后成功损失了它的灵魂也就是面，且现在做的非常难吃，作者已发誓再也不去禾苑。
...
\textbf{\subsection*{八、石大夜市}}
\addcontentsline{toc}{subsection}{2.8 \ 石大夜市}
\fontsize{14pt}{16.8pt}\selectfont
\setlength{\parindent}{2em} % 设置首行缩进为2字符
别问，问就是开的时间飘忽不定，导致作者每次都没去过，期待补全。

\textbf{\subsection*{九、中油大厦早餐点}}
\addcontentsline{toc}{subsection}{2.9 \ 中油大厦早餐点}
\fontsize{14pt}{16.8pt}\selectfont
\setlength{\parindent}{2em} % 设置首行缩进为2字符
东西卖的比较快，来晚了就没了。挺便宜，挺好吃，给桂花糕点赞。

\textbf{\subsection*{十、润杰食堂}}
\addcontentsline{toc}{subsection}{2.10 \ 润杰食堂}
\fontsize{14pt}{16.8pt}\selectfont
\setlength{\parindent}{2em} % 设置首行缩进为2字符
早餐提供包子、煎饼、煎饺、玉米、牛奶、豆浆等，中午和晚上，呵呵......

\textbf{\subsection*{十一、润杰西门口}}
\addcontentsline{toc}{subsection}{2.11 \ 润杰西门口}
\fontsize{14pt}{16.8pt}\selectfont
\setlength{\parindent}{2em} % 设置首行缩进为2字符
适合懒狗，右边的“学长学姐推荐店”和左边的烧饼比较好。另，左边的铁板炒饭炒粉似乎有卫生问题。

\newpage
\titleformat{\section}[block]{\normalfont\Large\bfseries\centering}{}{0pt}{}
\fontsize{26pt}{31.2pt}\selectfont
\textbf{\section{校外}}
\textbf{\subsection*{一、南校园闸机口一条街（燕平路）}}
\addcontentsline{toc}{subsection}{3.1 \ 南校园闸机口一条街（燕平路）}
\fontsize{14pt}{16.8pt}\selectfont
\setlength{\parindent}{2em} % 设置首行缩进为2字符
这条街作为润杰的同学们上学的必经之路，人流量极大，而且离学校和宿舍都近，非常适合不想去食堂的同学们，我选了其中几个尤其好的店做详细的介绍。
\begin{figure}[H]
	\centering
	\includegraphics[width=0.7\textwidth]{pics/校外/南校/1 南校园闸机口一条路.jpg}
\end{figure}
...
\textbf{\subsubsection*{7. 满巍明生炸鸡架（提供者：GF）}}
\addcontentsline{toc}{subsubsection}{3.1.8 \ 满巍明生炸鸡架}
很香，经常在放学路上被它馋得走不动道。但是也真的很贵，导致我到现在就买过一次。

\textbf{\subsubsection*{8. 江西瓦罐（提供者：GF）}}
\addcontentsline{toc}{subsubsection}{3.1.9 \ 江西瓦罐}
汤味道不错，粉也还说得过去，反正本人的江西朋友说不错。日常工作日吃的话，人均稍微有点高。

\textbf{\subsubsection*{9. 包顺昌（提供者：tractorchicken）}}
\addcontentsline{toc}{subsubsection}{3.1.9 \ 江西瓦罐}
味道不错，早八的合适选择，但早上要排队（而且非常长，很挡路）。

\textbf{\subsubsection*{10. 超意兴（提供者：tractorchicken）}}
\addcontentsline{toc}{subsubsection}{3.1.9 \ 江西瓦罐}
类似一餐三和二餐一的小碗菜，正餐一般20块一顿，偏咸。午晚餐的清蒸巴沙鱼味道不错但是较贵（18块）。


\textbf{\subsubsection*{11. KFC（提供者：tractorchicken）}}
\addcontentsline{toc}{subsubsection}{3.1.9 \ 江西瓦罐}
\textit{我本来是不想写KFC的，但是既然给我发了信息我就写上吧，这个就没啥好说的了，疯狂星期四V我50。}

\textbf{\subsubsection*{12. 袁记云饺（提供者：tractorchicken）}}
\addcontentsline{toc}{subsubsection}{3.1.9 \ 江西瓦罐}
价格高，味道好，一分价钱一分货。
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\textwidth]{pics/校外/清秀园/1 清秀园小区内.png}
\end{figure}

\textbf{\subsubsection*{1. 川菜馆}}
\addcontentsline{toc}{subsubsection}{3.2.1 \ 美味川菜馆}
...
\textbf{\subsubsection*{2. 啤酒超市}}
\addcontentsline{toc}{subsubsection}{3.2.2 \ 啤酒超市}
...
\textbf{\subsubsection*{3. 砂锅牛肉面}}
\addcontentsline{toc}{subsubsection}{3.2.3 \ 砂锅牛肉面}
这家可能是作者在学校附近找到的唯一一家砂锅牛肉面，确实好吃，店面一直开到晚上十点。要注意的是，砂锅刚上来的时候特别烫，建议先放10分钟再吃，不然嘴被烫伤问题就大了。

\textbf{\subsubsection*{4. 尝到家尝（提供者：Silenchatter）}}
\addcontentsline{toc}{subsubsection}{3.2.4 \ 尝到家尝}
北平人家旗下北京菜系，经典菜鱼头泡饼可食（最好多几个人）。他们家也是附近为数不多可以点豆汁的店，请挑战自己。

\textbf{\subsection*{三、润杰西门一条街（东环路）}}
\addcontentsline{toc}{subsection}{3.3 \ 润杰西门一条街（东环路）}
\fontsize{14pt}{16.8pt}\selectfont
\setlength{\parindent}{2em} % 设置首行缩进为2字符
懒狗必看。
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\textwidth]{pics/校外/润杰/1 润杰西门一条街（东环路）.png}
\end{figure}
...
\textbf{\subsubsection*{2. 山西面馆（提供者：tractorchicken）}}
\addcontentsline{toc}{subsubsection}{3.3.2 \ 山西面馆}
物美价廉的面馆，份量较足，口感不错，值得一试。

这里曾为除一餐麻辣香锅外昌平第二便宜麻辣烫，除味道有些淡以外无任何缺点，老板娘人特别好。原店于2025年关闭，保留此行以兹纪念。

\textbf{\subsection*{四、阳光商厦一条街（府学路）}}
\addcontentsline{toc}{subsection}{3.4 \ 阳光商厦一条街（府学路）}
\fontsize{14pt}{16.8pt}\selectfont
\setlength{\parindent}{2em} % 设置首行缩进为2字符
政法旁边，国泰对面，清秀园后面，就是著名的阳光商厦，周围东西不少，主要推荐以下。
\begin{figure}[H]
	\centering
	\includegraphics[width=1\textwidth]{pics/校外/阳光商厦/1 阳光商厦一条街（府学路）.jpg}
\end{figure}
...
\textbf{\subsubsection*{7. 虾吃虾涮/王婆大虾（提供者：Silenchatter）}}
\addcontentsline{toc}{subsubsection}{3.4.7 \ 虾吃虾涮/王婆大虾}
虾火锅。两家差不多，王婆人均高10，套餐适合团建。本人口味偏重，喜欢一口气把虾剥完后放回锅内吸汤，可以根据个人喜好吃。 

\textbf{GF更新：}虾吃虾涮在某音买团购后去吃。吃完虾锅还可以免费无线续面，特别好吃。

\newpage
\textbf{\subsection*{五、东校区一条街（亢山路）}}
\addcontentsline{toc}{subsection}{3.5 \ 东校区一条街（亢山路）}
\fontsize{14pt}{16.8pt}\selectfont
\setlength{\parindent}{2em} % 设置首行缩进为2字符
对于本科同学来说，东校区去的很少，对那一条街自然也就不甚了解。作者也尝试了一些，以下是一些比较好的店。
\begin{figure}[H]
	\centering
	\includegraphics[width=0.7\textwidth]{pics/校外/东校/1 东校区一条街（亢山路）.jpg}
\end{figure}
...
\textbf{注：此部分更新频率缓慢，可能出现已倒闭店铺！！！}
\begin{figure}[H]
	\centering
	\includegraphics[width=0.7\textwidth]{pics/校外/悦荟/悦荟.jpg}
\end{figure}
...
\textbf{\subsubsection*{4. 绿茶（提供者：Silenchatter）}}
\addcontentsline{toc}{subsubsection}{3.6.4 \ 绿茶}
适合3-6人聚餐。口味偏清，价格凑合，周末也是真的要排队。

\textbf{\subsubsection*{5. 文通冰室（提供者：Silenchatter）}}
\addcontentsline{toc}{subsubsection}{3.6.5 \ 文通冰室}
港式茶餐厅。这个领域内相对性价比高的一家店，多看看团购也许会有惊喜。

\textbf{\subsubsection*{6. 文立新麻辣烫（提供者：外语学院李雷锋）}}
\addcontentsline{toc}{subsubsection}{3.6.6 \ 文立新麻辣烫}
你以为东北大婶和颜悦色都是实诚人？不！精致小碟麻辣烫，宰你不留情面！

\textbf{\subsubsection*{7. 煲仔皇（提供者：GF）}}
\addcontentsline{toc}{subsubsection}{3.6.7 \ 煲仔皇}
-1层，好吃，强推。用了团购后价格合适。汤非常好喝，强烈建议吃煲仔饭的时候配上一碗汤。

\newpage
\textbf{\subsection*{七、政法东侧一条街（松原路）}}
\addcontentsline{toc}{subsection}{3.7 \ 政法东侧一条街（松原路）}
\fontsize{14pt}{16.8pt}\selectfont
吃的非常之多，能在这条街上活下来的都是有点手艺的强手。
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\textwidth]{pics/校外/政法/1 政法东侧一条街（松原路）.jpg}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\textwidth]{pics/校外/更远/晋永信.png}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\textwidth]{pics/校外/更远/烤馕.png}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\textwidth]{pics/校外/更远/姜胖胖.png}
\end{figure}
...
\textbf{\subsubsection*{4. 京北128号火锅鸡（提供者：Silenchatter）}}
\addcontentsline{toc}{subsubsection}{3.8.4 \ 京北128号火锅鸡}
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\textwidth]{pics/校外/更远/火锅鸡.png}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\textwidth]{pics/校外/更远/锦州.png}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\textwidth]{pics/校外/更远/砂锅牛.png}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\textwidth]{pics/校外/更远/马记.png}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\textwidth]{pics/校外/更远/邹三姐.png}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\textwidth]{pics/校外/更远/齐齐哈尔.png}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\textwidth]{pics/校外/更远/山河屯.png}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.67\textwidth]{pics/校外/更远/巫山.png}
\end{figure}
这是一家拥有两种流派选择的店。
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.67\textwidth]{pics/校外/更远/车轮饼.png}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.7\textwidth]{pics/校外/更远/麦香炸鸡.png}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\textwidth]{pics/校外/更远/巴依老爷.png}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\textwidth]{pics/校外/更远/思念妈妈东北菜馆.png}
\end{figure}

\textbf{\subsubsection*{16. 沧州火锅鸡}}
北京，人均40，火锅鸡，免费小菜，自家酿醋，还需要我多说吗，冲就完了！
\addcontentsline{toc}{subsubsection}{3.8.16 \ 沧州火锅鸡}
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\textwidth]{pics/校外/更远/沧州火锅鸡.png}
\end{figure}
...
\begin{tabularx}{\textwidth}{|>{\centering\arraybackslash}m{2cm}
    ...
    \hline
    v3.0   & 2024.9.1  & \textbf{第一次重大更新} Latex 重写排版；新增 3.6 悦荟 \\ 
    \hline
    v4.0   & 2024.9.4  & \textbf{第二次重大更新} 更换封面学校图标；删除原 3.5.2 胡辣汤；修正汉堡王配图错误；修正达美乐写成好利来错误；修正禾苑、KFC 歧义；新增一餐内容；新增 28 条校外内容；修改全文字体、页面样式、附录内容 \\ 
    \hline
